...
const result = (res1, res2, res3) => (res1 + res2 + res3) / 3

let score1 = result(44, 23, 71)
let score2 = result(65, 54, 49)

console.log(score1)
console.log(score2)

const winner= (scorcat, scordog) => {
 if (scorcat >= scordog * 2) {
        alert(`Победил ${scorcat}`) 
    } else if (scordog >= scorcat *2) {
        alert(`Победил ${scordog}`) 
    } else {
        alert('Ничья ')
    }
